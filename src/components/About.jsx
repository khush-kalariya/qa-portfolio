          ...
          <div className="lg:col-span-7 about-editorial bg-white border-4 border-black p-8 shadow-[8px_8px_0px_#000000] text-left">
            ...
            <div className="bg-[#FF2D75] text-white border-4 border-black p-6 mb-6 shadow-[4px_4px_0px_#000000] rotate-[-1deg]">
              <p className="font-display font-black text-xl md:text-2xl leading-snug">
                "THOROUGH MANUAL TESTING DOESN'T JUST CHECK IF SOFTWARE WORKS — IT ENSURES A SMOOTH, BUG-FREE USER EXPERIENCE."
              </p>
            </div>

            <div className="space-y-6 text-base md:text-lg leading-relaxed text-[#111111] font-medium">
              <p>
                Hello, I'm Khush. I approach Manual QA Engineering not just as a checklists checker, but as a critical product analyst. I thrive on diving deep into product requirements, identifying logical loopholes, designing extensive test matrices, and running thorough manual regressions.
              </p>
              <p>
              ...
              <p>
                Whether it is verifying complex API states in Postman, writing SQL queries to validate database updates, checking responsive rendering on dynamic mobile layouts, or performing exploratory bug hunts, my goal as a Manual QA Tester is absolute software stability.
              </p>
            </div>
          </div>

          {/* Right Column: Small Quick-Info Cards */}
          <div className="lg:col-span-5 grid grid-cols-1 gap-6 about-stat-card-trigger">

            {/* Card 1: Experience */}
            <div className="about-stat-card bg-[#FFD600] border-4 border-black p-5 shadow-[4px_4px_0px_#000000] text-left hover:-translate-y-1 hover:shadow-[6px_6px_0px_#000000] transition-all flex items-center gap-4">
              ...
              <div>
                ...
                <p className="font-mono text-xs opacity-75 mt-1">Manual & Functional QA</p>
              </div>
            </div>

            {/* Card 2: Education */}
            <div className="about-stat-card bg-white border-4 border-black p-5 shadow-[4px_4px_0px_#000000] text-left hover:-translate-y-1 hover:shadow-[6px_6px_0px_#000000] transition-all flex items-center gap-4">
              <div className="w-12 h-12 bg-[#00E5FF] border-3 border-black flex items-center justify-center shrink-0">
              ...
              <div>
                ...
                <p className="font-mono text-xs opacity-75 mt-1">Master of Computer Applications</p>
              </div>
            </div>

            {/* Card 3: Location */}
            <div className="about-stat-card bg-white border-4 border-black p-5 shadow-[4px_4px_0px_#000000] text-left hover:-translate-y-1 hover:shadow-[6px_6px_0px_#000000] transition-all flex items-center gap-4">
              <div className="w-12 h-12 bg-[#FF2D75] border-3 border-black flex items-center justify-center text-white shrink-0">
              ...
              <div>
                ...
                <p className="font-mono text-xs opacity-75 mt-1">India</p>
              </div>
            </div>

            {/* Card 4: Languages */}
            <div className="about-stat-card bg-[#00E5FF] border-4 border-black p-5 shadow-[4px_4px_0px_#000000] text-left hover:-translate-y-1 hover:shadow-[6px_6px_0px_#000000] transition-all flex items-center gap-4">
              <div className="w-12 h-12 bg-white border-3 border-black flex items-center justify-center shrink-0">
              ...
              <div>
                ...
                <p className="font-mono text-xs opacity-75 mt-1">Fluent in all three</p>
              </div>
            </div>
